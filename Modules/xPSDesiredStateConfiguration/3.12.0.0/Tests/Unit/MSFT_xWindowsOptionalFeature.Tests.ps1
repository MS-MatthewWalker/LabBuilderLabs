...
try
{
    ...
    InModuleScope $Global:DSCResourceName {
        ...
        Describe "$($Global:DSCResourceName)\ConvertStateToEnsure" {    
        ...
        } #end Describe ConvertStateToEnsure

        Describe "$($Global:DSCResourceName)\ValidatePrerequisites" {    
        ...
        } #end Describe ValidatePrerequisites
